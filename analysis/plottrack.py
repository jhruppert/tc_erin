...
#plt.plot(lons, lats, linestyle='--', marker='o', color='b', label='Simulated Track Avo')
#plt.plot(lons3, lats3, linestyle='--', marker='o', color='g', label='Simulated Track Surface Rvor')
